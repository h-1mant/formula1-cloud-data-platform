...
drivers_df = (
    spark.read
    .option('header','True')
    .schema(drivers_schema) #Ingestion Schema
    .json(get_adls_path('raw', f'{file_date}/drivers.json'))
...
merge_pattern(drivers_df, container, path, merge_col, dest_format)
